                  ...
                  <div class="card card-notification shadow-none" style="max-width: 20rem">
                    <div class="card-header">
                      <div class="row justify-content-between align-items-center">
                        <div class="col-auto">
                          <h6 class="card-header-title mb-0">Rupture de stock
                          </h6>
                        </div>
                        <div class="col-auto"><a class="card-link font-weight-normal" href="#">2 produits</a></div>
                      </div>
                    </div>
                   {{--  <div class="list-group list-group-flush font-weight-normal fs--1">
                    ...
                    <div class="card-footer text-center border-top-0"><a class="card-link d-block" href="pages/notifications.html">View all
                    </a></div> --}}
                  </div>
                </div>
