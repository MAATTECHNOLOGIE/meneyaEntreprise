            ...
            <nav class="navbar navbar-expand-lg navbar-light py-3" aria-label="Main navigation">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav align-items-lg-center pt-3 pt-lg-0 ml-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#">Gérer et contrôler votre business</a>
                        </li>
                    </ul>
                </div>
            </nav>
            ...
            <div class="container text-white">
                <div class="row">
                    <div class="col-md-7 mb-5 mb-md-0">
                        <h1 class="display-4">Acheter Meneya</h1>
                        <p class="lead">Utilisez toutes nos fonctionnalités à<br>200.000 FCFA</p>
                ...
                <div class="row justify-content-lg-center">
                    <div class="col-lg-9">
                        ...
                        <form class="py-4">
                            ...
                            <div class="form-group">
                                <label for="email" class="small text-uppercase">Email
                                </label>
                            ...
                            <div class="form-group">
                                <label for="activities" class="small text-uppercase">Domaine d'activité</label>
                                <input type="text" id="activities" name="activites" 
                                class="form-control">
                            </div>

                            <div class="form-group form-check">
                                <input type="checkbox" id="terms" 
                                class="form-check-input" name="infos">
                                <label class="form-check-label small" for="terms"><a href="#">Rester informer</a></label>
                            </div>
                            <button type="submit" class="achat btn btn-primary rounded-pill" style="background-color:#bd003b;">
                              Acheter
                            </button>
                        </form>
                    </div>
