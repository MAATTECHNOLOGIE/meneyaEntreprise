...
<body>
            ...
            <nav class="navbar navbar-expand-lg navbar-light py-3" aria-label="Main navigation">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav align-items-lg-center pt-3 pt-lg-0 ml-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#">Exploiter toutes les fonctionnalités</a>
                        </li>
                    </ul>
                </div>
            </nav>
    ...
    <main id="main">
        ...
        style="background-image: url(landing/img/conference2.jpg)">
            <div class="bg-overlay  alpha-7"></div>
            <div class="container text-white">
                <div class="row">
                    <div class="col-md-7 mb-5 mb-md-0">
                        <h1 class="display-4">Meneya, Abonnez-vous</h1>
                        <p class="lead">Bénéficier de toutes nos fonctionnalités à 
                        <br>10.000 fcfa/mois</p>
                    ...
                    <div class="col-lg-9">
                        ...
                        <form class="py-4">
                            <div class="form-group">
                                <label for="name" class="small text-uppercase">Nom <span class="text-primary">*</span></label>
                                <input type="text" id="name" class="form-control" required name="nom">
                            </div>
                            <div class="form-group">
                                <label for="pays" class="small text-uppercase">Pays <span class="text-primary">*</span></label>
                                <input type="text" id="pays" class="form-control" required name="pays">
                            </div>

                            <div class="form-group">
                                <label for="tel" class="small text-uppercase">Numéro de téléphone<span class="text-primary">*</span></label>
                                <input type="number" id="tel" class="form-control" required name="tel">
                            </div>
                            ...
                            <div class="form-group">
                                <label for="email" class="small text-uppercase">Domaine d'activité</label>
                                <input type="text" id="activite" class="form-control">
                            </div>
                            ...
                            <button type="submit" class="abonner btn btn-primary rounded-pill" 
          ...
          <div class="modal-content">
            <div class="modal-footer">
              <button type="button" class="btn btn-secondary" data-dismiss="modal">
                 Valider avec succès, nous vous contacterons
              </button>
            </div>
          </div>
        </div>
